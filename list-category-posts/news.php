...
foreach ($this->catlist->get_categories_posts() as $single):
    ...
    //Show the title and link to the post: //Show date:
    $lcp_display_output .= '<span><h2>'.$this->get_post_title($single).'</h2></span>';
     ...
     */
    $lcp_display_output .= $this->get_excerpt($single, 'div', 'lcp_excerpt wine-ex').'<a href="'.get_permalink($single->ID).'">Read more</a>';
